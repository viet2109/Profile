...
const ContactCard = ({ icon, title = "", desc = "" }) => {
    return (
        <div className='w-full rounded-md p-5 flex items-center transition hover:border-primary border-[2px] border-black mb-4 bg-white bg-opacity-5 dark:border-section dark:border'>
